    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-beige via-white to-gray-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-brand-black mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button 
              size="lg" 
              className="bg-brand-orange hover:bg-brand-orange/90 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl animate-glow"
            >
              {t('hero.cta.services')}
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-2 border-brand-orange text-brand-orange hover:bg-brand-orange hover:text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 hover:scale-105"
            >
              {t('hero.cta.contact')}
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              ...
              <h3 className="text-3xl font-bold text-brand-black mb-2">15+</h3>
              <p className="text-brand-gray font-medium">{t('hero.stats.experience')}</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              <Users className="h-12 w-12 text-brand-orange mx-auto mb-4" />
              <h3 className="text-3xl font-bold text-brand-black mb-2">200+</h3>
              <p className="text-brand-gray font-medium">{t('hero.stats.companies')}</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              <TrendingUp className="h-12 w-12 text-brand-orange mx-auto mb-4" />
              <h3 className="text-3xl font-bold text-brand-black mb-2">98%</h3>
              <p className="text-brand-gray font-medium">{t('hero.stats.satisfaction')}</p>
            </div>
          </div>
        </div>
      </div>
